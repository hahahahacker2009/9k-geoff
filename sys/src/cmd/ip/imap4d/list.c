...
static int	checkMatch(char *cmd, char *ref, char *pat, char *mbox, ulong mtime, int isdir);
static int	listAll(char *cmd, char *ref, char *pat, char *mbox, ulong mtime);
 ...
 */
static int
listAll(char *cmd, char *ref, char *pat, char *mbox, ulong mtime)
{
	Dir *dirs;
	char *mb;
	int i, nmb, nd, ok, fd;
 ...
 */
static int
checkMatch(char *cmd, char *ref, char *pat, char *mbox, ulong mtime, int isdir)
{
	char *s, *flags;
