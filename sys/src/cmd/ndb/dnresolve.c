...
//	Minwaitms=	750,	/* minimum wait for a remote dns query */
	Minwaitms=	3000,	/* minimum wait for a remote dns query */
 ...
 * wait at most for the sooner of waitms from now and qp->req->aborttime.
 */
static int
