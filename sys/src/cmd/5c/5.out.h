...
/* old FPA, etc. had 8 regs, current VFP has 16 or 32 double regs. */
#define	NFREG		16
#define	FREGRET		0
/* compiler allocates register variables F0 up */
/* compiler allocates external registers FREGEXT down */
#define	FREGEXT		(NFREG-2)
#define	FREGTMP		(NFREG-1)
