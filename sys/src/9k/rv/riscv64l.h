...
#define HWPF0	0x7c3	/* sifive pre-fetcher, M mode only */
#define HWPF1	0x7c4
...
#define Svshft	60
#define Svmask	(VMASK(4)<<Svshft)	/* paging enable modes */
...
#define Ptemtmask	(3LL<<61)	/* memory type mask, leaf only */
#define PteN	(1ULL<<63)	/* Svnapot extension */

#define PteRWX	(PteR|PteW|PteX)	/* all access; only in a leaf */
#define PtePtr	0	/* attr: address is next level ptr */
#define PteLeaf	PteRWX	/* if 0, next level; non-0 is leaf */
#define PteNonleaf0	(PteU|PteA|PteD|PteNc|PteIo)
