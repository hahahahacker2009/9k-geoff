...
/*
 * attempt to execute uncompressed instructions at insts with argument new and
 * pointer to success/failure status.  insts must include a RET.  probeinstr
 * returns the result and copes with illegal instructions via trapillinst.
 */
uintptr
