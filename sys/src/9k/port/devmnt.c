/*
 * devmnt - convert file system calls on (remote) files under this mountpoint
 * into 9P messages to the network, and the reverse for results of those
 * messages.  the inverse of exportfs.
 */
#include	"u.h"
#include	"../port/lib.h"
#include	"mem.h"
 ...
 */
/* we may be overrunning the p550's dwmac */
#define MAXRPC (IOHDRSZ+16*1024) /* see MAXRPC in exportfs; was 8K+IOHDRSZ */
...
alloctag(void)
{
	...
	panic("devmnt: no friggin tags left");
//	return NOTAG;
}
