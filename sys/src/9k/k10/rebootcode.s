...
/*
 * copied from l64lme.s; no -KZERO in _gdtptr32p.
 * otherwise should be identical here and there.
 */
/* long mode descriptors */
TEXT _gdt32p(SB), 1, $-4
	QUAD	$0				/* NULL descriptor */
	QUAD	$(SdG|SdD|Sd4G|SdP|SdS|SdCODE|SdR|0xffff) /* CS */
	QUAD	$(SdG|SdD|Sd4G|SdP|SdS|SdW|0xffff)	/* DS */
	QUAD	$(SdL|SdP|SdS|SdCODE)		/* 64-bit CS */
...
TEXT compat32(SB), 1, $-4
	...
	CLI
	MOVL	$RMSTACK, SP		/* new stack below pxe base */
	MFENCE
DBGPUT('3', c3lab)
