...
#define La57	(1<<12)	/* 5-level page tbls, 57-bit VAs */
...
#define Tscr	0x10	/* time-stamp counter */
#define Pwroncfg	0x2a
#define Fsbfreqr	0x2c
...
#define Lme	0x00000100	/* Long Mode Enable when paging */
...
#define PteP	0x01ull	/* Present */
#define PteRW	0x02ull	/* Read/Write */
#define PteU	0x04ull	/* User/Supervisor */
#define PtePWT	0x08ull	/* Page-Level Write Through */
#define PtePCD	0x10ull	/* Page Level Cache Disable */
#define PteA	0x20ull	/* Accessed */
#define PteD	0x40ull	/* Dirty */
#define PtePS	0x80ull
#define Pte4KPAT	PtePS	/* PTE PAT */
#define PteG	0x00000100ull	/* Global */
#define Pte2MPAT	0x00001000ull	/* PDE PAT */
#define Pte1GPAT	Pte2MPAT	/* PDPE PAT */
#define PteNX	(1ull<<63)	/* No Execute */
...
#define SdR	0x0000020000000000ull	/* Readable (Code); else exec */
