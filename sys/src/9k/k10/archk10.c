...
/* Xeons implement ECC memory; almost no other Intel models do. */
static Inmodels in6models[] = {
	...
	0x2e, "xeon 6000 mp",
	0x2f, "xeon e7 mp",
	0x36, "atom n2000/d2000",
	0x3a, "xeon e3/core i3/i5/i7",	/* ~2012 ivy bridge */
	0x3c, "xeon/core i7",		/* haswell */
	0x3d, "core (i7|m)-5557u nuc",	/* broadwell */
	0x3e, "core i7",		/* ivy bridge */
	0x3f, "core i7",		/* haswell */
	0x45, "core i5-4302y",		/* haswell */
	0x46, "core i5/i7",		/* haswell */
	0x4a, "edison",			/* silvermont */
	0x4d, "atom c2xxx",		/* silvermont */
	0x9e, "xeon e3-1275 v6",	/* ~2017 coffee lake */
};
...
microdelay(vlong microsecs)
{
	...
	if (microsecs <= 0)
		return;
	now = rdtsc();
	t = now + microsecs*m->cpumhz;
	dogincr = Wdogms * 1000ll * m->cpumhz;
...
#ifdef unused
void
l2cacheflush(void *, uintptr)
{
	/* no-op on x86 and amd64 */
}

void
cachedwbinvse(void *, int)
{
	/* no-op on x86 and amd64 */
}
#endif
