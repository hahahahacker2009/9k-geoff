/*
 * #P/realmode*, to let vga muck with low memory and issue bios calls
 */
#include	"u.h"
#include	"../port/lib.h"
#include	"mem.h"
...
/*
 * Back the processor into real mode to run a BIOS call specified in *ureg,
 * then reverse and return.  This must be used carefully, since it
