 ...
 * or new systems (intel removed a20 gate in 2008).
 */
	LWI(0x2401, rAX)
	BIOSCALL(0x15)
...
#endif
#ifndef QEMU
	/* qemu can't handle this; real machines do.  DS was set to CS above. */
	CLR(rAX)
//	MTSR(rAX, rDS)	// TODO restore after testing?
#endif
	LLI(_hello(SB), rSI)
	CALL16(_cgaputs(SB))
...
#ifdef HAVE_FLOPPY
/*
 * Reset floppy disc system, if present (pre-2011).
